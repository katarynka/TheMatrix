...
res_numpy = np.matmul(M11,M21)
transpose(Matrix(4,4,M21))
res_transposed = elementary_multiplication_transposed(Matrix(4,4,M11), Matrix(4,4,M21))
print(res_numpy)
print(res_transposed)
# R1 = elementary_multiplication(M1,M2)
# R2 = np.matmul(M11,M21)
# print(np.testing.assert_allclose(R1,R2))
